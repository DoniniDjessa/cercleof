...
-- Create updated_at functions (DROP IF EXISTS first to avoid conflicts)
DROP FUNCTION IF EXISTS update_categories_updated_at_column() CASCADE;
DROP FUNCTION IF EXISTS update_products_updated_at_column() CASCADE;
...
DROP TRIGGER IF EXISTS update_dd_categories_updated_at ON "dd-categories";
DROP TRIGGER IF EXISTS update_dd_products_updated_at ON "dd-products";
DROP TRIGGER IF EXISTS update_dd_services_updated_at ON "dd-services";
...
DROP POLICY IF EXISTS "All users can view categories" ON "dd-categories";
DROP POLICY IF EXISTS "All users can create categories" ON "dd-categories";
DROP POLICY IF EXISTS "All users can update categories" ON "dd-categories";
DROP POLICY IF EXISTS "Admin and manager can delete categories" ON "dd-categories";

DROP POLICY IF EXISTS "All users can view products" ON "dd-products";
DROP POLICY IF EXISTS "All users can create products" ON "dd-products";
DROP POLICY IF EXISTS "All users can update products" ON "dd-products";
DROP POLICY IF EXISTS "Admin and manager can delete products" ON "dd-products";

DROP POLICY IF EXISTS "All users can view services" ON "dd-services";
DROP POLICY IF EXISTS "All users can create services" ON "dd-services";
DROP POLICY IF EXISTS "All users can update services" ON "dd-services";
DROP POLICY IF EXISTS "Admin and manager can delete services" ON "dd-services";
